...
export default function ArticleUpadesam() {
  return (
   ...
   <div className="huge">
    ...
    <div className="body">
    <Answer>
      Some anbargal who met Siva in May 2007 narrated this incident.
      <div>
      "While sitting with Siva in his hut near South gate,
      he told us I have to sit here for 40 more years for complete transformation.
      Then he said, all service like giving neermoru and all that helps to develop bhakti.
      </div>
      <div>
      Siva narrated a story.
